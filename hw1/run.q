...
.aq.show `my_table set ([]ID:"j"$();date:"j"$();endofdayprice:"j"$());

.aq.show .aq.load[hsym `$"ticks.csv";",";`my_table];

.aq.show `my_table2 set {
 .aq.initQueryState[];
 aq__t0:.aq.initTable[my_table;"my_table";0b];
 aq__t0:.aq.sort[aq__t0;((iasc;{x^.aq.cd x} `ID);(iasc;{x^.aq.cd x} `date));({x^.aq.cd x} `ID;{x^.aq.cd x} `date;{x^.aq.cd x} `endofdayprice)];
 aq__t0:?[aq__t0;();0b;((`ID);(`date);(`ratio))!({x^.aq.cd x} `ID;{x^.aq.cd x} `date;(.aq.ratios;1;{x^.aq.cd x} `endofdayprice))];
 aq__t0
 }[];

.aq.show .aq.save[hsym `$"table2.csv";","; ] {
  .aq.initQueryState[];
 aq__t0:.aq.initTable[my_table2;"my_table2";0b];
 aq__t0:?[aq__t0;();0b;((`ID);(`date);(`ratio))!({x^.aq.cd x} `ID;{x^.aq.cd x} `date;{x^.aq.cd x} `ratio)];
 aq__t0
 }[];

.aq.show .aq.save[hsym `$"ticks_ratios.csv";"|"; ] {
  .aq.initQueryState[];
 aq__t0:.aq.initTable[my_table2;"my_table2";0b];
 aq__t0:.aq.sort[aq__t0;enlist ((iasc;{x^.aq.cd x} `ID));((.aq.wildCard aq__t0))];
 aq__t0:?[aq__t0;();(enlist[{x^.aq.cd x} `ID]!enlist {x^.aq.cd x} `ID);({x^.aq.cd x} `ID) _ (.aq.wildCard aq__t0)];
 aq__t0:?[aq__t0;();0b;((`ID);(`max_ratio);(`min_ratio))!({x^.aq.cd x} `ID;(.aq.max';{x^.aq.cd x} `ratio);(.aq.min';{x^.aq.cd x} `ratio))];
 aq__t0
 }[];
